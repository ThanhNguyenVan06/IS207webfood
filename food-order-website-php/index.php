...
?>
        <div style="z-index: 3;" class="banner js-banner">
            <div class="banner-close js-close-btn">
                <button>X</button>
            </div>
            <div class="banner-content">
                <img src="<?php echo SITEURL; ?>images/banner/<?php echo $image_name3; ?>" alt="Banner" class="img-responsive img-curve">
            </div>
        </div>
<?php
...
<script>
    ...
    const bannerClose = document.querySelector('.js-close-btn');

    function hideBanner() {
        banner.classList.add('nonedis');
    }
    ...
    <div class="container">
        ...
        ?>
                ...
                <a href="<?php echo SITEURL; ?>category-foods.php?category_id=<?php echo $id; ?>">
                    <div style="z-index: 1;" class="box-3 float-container">
                        <?php
